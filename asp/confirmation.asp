...
titulo_msg    = request.QueryString("titulo_msg")
...
<body class="popup">
	...
	<div class="centro" style="width: 94%; margin: auto">
		...
		<a class='link_serv' href="javascript:parent.PopupConfirma('<%=url%>', '<%=titulo_msg%>' , <%=height%>,  <%=Weight%>);parent.fechaPopup();"><%=getTermo(global_idioma, 783, "Sim", 0)%></a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
