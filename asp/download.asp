...
%><!-- #include file="../libasp/updChannelProperty.asp" --><%	
	...
	ROService.ContaAcessosMidias CLng(codObra), CLng(codMidia), CLng(tipoMidia), CLng(usuario), 0
	...
	'******************************************
        ...
        Set DownloadMidia = ROService.InicializaDownloadMidia(CLng(codMidia), CLng(tipoMidia), false)
