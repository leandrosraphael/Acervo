...
if Request.QueryString("veio_de") = "circulacao" then
	Response.Write "&nbsp;&nbsp;&nbsp;&nbsp;<a class='link_serv' href=""javascript:LinkCirculacoes(parent.hiddenFrame.modo_busca);""><span class='transparent-icon removerBordas span_imagem icon_16 icon-small-back'></span>&nbsp;"&getTermo(global_idioma, 1386, "voltar", 2)&"</a>"
elseif Request.QueryString("veio_de") = "reserva" then
	Response.Write "&nbsp;&nbsp;&nbsp;&nbsp;<a class='link_serv' href=""javascript:LinkReservas(parent.hiddenFrame.modo_busca);""><span class='transparent-icon removerBordas span_imagem icon_16 icon-small-back'></span>&nbsp;"&getTermo(global_idioma, 1386, "voltar", 2)&"</a>"
elseif Request.QueryString("veio_de") = "bibcurso" then
	Response.Write "&nbsp;&nbsp;&nbsp;&nbsp;<a class='link_serv' href=""javascript:LinkBibCurso(parent.hiddenFrame.modo_busca,'detalhe');""><span class='transparent-icon removerBordas span_imagem icon_16 icon-small-back'></span>&nbsp;"&getTermo(global_idioma, 1386, "voltar", 2)&"</a>"
elseif Request.QueryString("veio_de") = "sels" then
	Response.Write "&nbsp;&nbsp;&nbsp;&nbsp;<a class='link_serv' href=""javascript:LinkSelecao(parent.hiddenFrame.modo_busca);""><span class='transparent-icon removerBordas span_imagem icon_16 icon-small-back'></span>&nbsp;"&getTermo(global_idioma, 1386, "voltar", 2)&"</a>"
...
<td class="td_center_middle td_abas_detalhe_aacr2" id="tdx_a5"><a class="link_abas" href="#" onClick="habilitaMarc(1,parent.hiddenFrame.layerX,'detalhes',<%=codigo_obra%>,<%=Tipo%>);" id="lk_a5"><%=FichaResumida%></a></td>
<td class="td_center_middle td_abas_detalhe_marc" id="tdx_b5"><a class="link_abas" href="#" onClick="habilitaMarc(1,parent.hiddenFrame.layerX,'marcTags',<%=codigo_obra%>,<%=Tipo%>);" id="lk_b5"><%=getTermo(global_idioma, 997, "MARC tags", 0)%></a></td>
<td class="td_center_middle td_abas_detalhe_marc" id="tdx_dc5"><a class="link_abas" href="#" onclick="habilitaMarc(0,parent.hiddenFrame.layerX,'dublinCore',<%=codigo_obra%>,<%=Tipo%>);" id="lk_dc5">Dublin Core</a></td>

<% if (possui_estrutura_hierarquica) then %>
	<td class="td_center_middle td_abas_detalhe_marc" id="tdx_c5"><a class="link_abas" href="#" onclick="habilitaMarc(1,parent.hiddenFrame.layerX,'arquivo',<%=codigo_obra%>,<%=Tipo%>);" id="lk_c5"><%=getTermo(global_idioma, 7482, "Registros relacionados", 0)%></a></td>
<% end if %>
...
<% if (possui_estrutura_hierarquica) then %>
	<td class="td_right_bottom td_abas_detalhe_aacr2_centro" id="tdx_mt3">&nbsp;</td>
<% end if %>
...
<% if (possui_estrutura_hierarquica) then %>
	<td colspan="5" class='td_center_top marc_tags'>&nbsp;<b>Dublin Core</b>&nbsp;</td>
	</tr>
	<tr><td colspan="5" class="td_center_top td_marc td-ficha-marc">
<% else %>
...
<%
Response.Write "<div id='dDublinCore'><span class='span_imagem div_imagem_right icon_16 mozilla_blu '></span>&nbsp;"&getTermo(global_idioma,32,"Carregando",0)&"...</div>"
%>
</td>
</tr>
</table>
...
<% if Request.QueryString("ve_marc") = "div_dublin_core" then %>	
