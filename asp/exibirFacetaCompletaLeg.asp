...
<script src="../scripts/jquery/jquery-3.2.1.min.js"></script>
    ...
    <script type="text/javascript">
	    function aplicarSelecao() {
	        ...
	        parent.AplicarFacetaVerMaisLeg(servidor, idFaceta, faceta);
	        parent.fechaPopup();
...
<%
    ...
    iFaceta = IntQueryString("iFaceta", 7)
    ...
    XMLFaceta = ROService.MontarFacetaLegislacao(Session("TabTempLeg_Srv" & iIndexSrv), Session("Faceta_leg_norma_Srv" & iIndexSrv), _
        ...
        Session("Faceta_leg_ano_Srv" & iIndexSrv), Session("Faceta_leg_assunto_Srv" & iIndexSrv), 0, iFaceta, global_idioma)
    ...
    Select case iFaceta
        Case 4
            sSelecaoFaceta = Session("Faceta_leg_ano_Srv" & iIndexSrv)
        Case 6
            sSelecaoFaceta = Session("Faceta_leg_assunto_Srv" & iIndexSrv)
        Case 7
            sSelecaoFaceta = Session("Faceta_leg_norma_Srv" & iIndexSrv)
        Case 8
            sSelecaoFaceta = Session("Faceta_leg_orgao_Srv" & iIndexSrv)
        Case 9
            sSelecaoFaceta = Session("Faceta_leg_situacao_Srv" & iIndexSrv)
    End Select
%>
<body class="popup">
                ...
                <div style="height: 420px; max-height: 420px; overflow: auto;">
                    ...
                    if (left(XMLFaceta, 5) = "<?xml") then
                        ...
                        if xmlRoot.nodeName = "facetas" then
                            ...
                            Response.Write "<form id='faceta-form-ver-mais' data-servidor='" & iIndexSrv & "' data-faceta-id='faceta_leg_" & idGrupo & "' method='POST'>"
                            ...
                            For Each xmlItem In xmlFaceta.childNodes
                                ...
                                Response.Write "<input type='checkbox' name='faceta_leg_" & idGrupo & "' value='" & idFaceta & "' " & selecionado & " />"
                                Response.Write "</td>"
